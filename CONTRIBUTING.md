...
Please note we have a code of conduct (MVC,...), please follow it in all your interactions with the project.

## Setting Up the project locally

To install the project you need to have `JAVA JDK` and `MySQL`
